            ...
            <header class="header">
                <div class="container-fluid px-lg-5">
                    ...
                    <nav class="py-4">
                        <div id="logo">
                            <h1>
                                <a href="#" class="editContent" style="">DjangoMovie</a></h1>
                        </div>
                        ...
                        <ul class="menu mt-2">
                            ...
                            <li><a href="#" class="exit">Вход</a></li>
                        </ul>
                    </nav>
                    <!-- //nav -->
                </div>
...
a.editContent{
    ...
    cursor: inherit; color: rgb(255, 255, 255);
    font-size: 40px; background-color: rgba(0, 0, 0, 0);
